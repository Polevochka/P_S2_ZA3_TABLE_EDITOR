...
begin
  ...
  begin
    ...
    begin
      ...
      count_file := 0;
      // сначла считаем, что у студенто больше всех баллов
      i_ins:= 0;
      ...
      begin
        ...
        // если его сумма баллов студента из файла
        // больше суммы баллов вставляемого студента
        if (s_file.o1 + s_file.o2 + s_file.o3 > s.o1 + s.o2 + s.o3) then
          // запоминаем позицию куда надо вставить студента
          // то есть ПСОЛЕ текущего вставляем
          i_ins:= count_file;

        // отдельно рассмотрим случай - когда сумма баллов этих студентов одинакова
